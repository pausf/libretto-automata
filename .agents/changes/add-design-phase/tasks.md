...
- [x] **Phase 5 becomes the how** — `skills/write-plan/SKILL.md` rewritten: technical
...
- [x] **The tasks seam** — `skills/write-tasks/SKILL.md` carrying everything the old
...
- [x] **Every remaining reference to the checklist by its old name** — `find-work`,
...
- [x] **The documents** — `docs/FLOW.md` §5 rewritten and the 5→6 seam added; the two
